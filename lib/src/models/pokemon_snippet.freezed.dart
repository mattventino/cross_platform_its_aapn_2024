...
/// @nodoc
@JsonSerializable()
class _$PokemonSnippetImpl implements _PokemonSnippet {
  _$PokemonSnippetImpl({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'PokemonSnippet(id: $id, name: $name)';
  }
...
abstract class _PokemonSnippet implements PokemonSnippet {
  factory _PokemonSnippet({required final int id, required final String name}) =
